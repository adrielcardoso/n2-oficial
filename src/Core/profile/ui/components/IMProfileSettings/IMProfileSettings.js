...
function IMProfileSettings(props) {
  ...
  const renderSettingsType = ({
    ...
    <TouchableOpacity
      ...
      onPress={() => onSettingsTypePress(type, action, routeName, form, screenTitle)}>
