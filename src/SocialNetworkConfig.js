...
const SocialNetworkConfig = {
  ...
  tabIcons: {
    ...
    CalendarioScreen: {
      focus: AppStyles.iconSet.agenda,
      unFocus: AppStyles.iconSet.agenda,
    },
    BIScreen: {
      focus: AppStyles.iconSet.anal,
      unFocus: AppStyles.iconSet.anal,
    },
    Feed: {
      focus: AppStyles.iconSet.homefilled,
      unFocus: AppStyles.iconSet.homeUnfilled,
  ...
  tosLink: 'https://www.instagram.com/dooweb/',
  ...
  contactUsPhoneNumber: '+5548999636872',
  adsConfig: {
    facebookAdsPlacementID: 'x',
